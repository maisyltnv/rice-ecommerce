    ...
    return (
        <div className="container mx-auto p-4 md:p-6 space-y-6 pt-20 md:pt-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">ຈັດການໝວດໝູ່ສິນຄ້າ</h1>
                    <p className="text-sm sm:text-base text-gray-600 mt-1">ຈັດການໝວດໝູ່ສິນຄ້າທັງໝົດໃນລະບົບ</p>
                </div>
