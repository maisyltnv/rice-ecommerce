        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-playfair text-3xl sm:text-4xl font-bold text-foreground mb-6">
              ເຂົ້າທີ່ປູກດ້ວຍວິຖີດັ່ງເດີມ ໂດຍໃຊ້ປຸ໋ຍຊີວະພາບ
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              ຕະລອດ 3 ຮຸ່ນ ພວກເຮົາອຸທິດຕົນນຳສົ່ງເຂົ້າຊະນິດທີ່ດີທີ່ສຸດຈາກທົ່ວປະເທດລາວມາໃຫ້ທ່ານ.
              ຄຳຫມັ້ນສັນຍາຂອງເຮົາຕໍ່ຄຸນນະພາບ ຄວາມຍືນຍົງ ແລະປະເພນີ ຮັບປະກັນວ່າແຕ່ລະເມັດເຂົ້າໄດ້ຕາມມາດຕະຖານທີ່ເຂັ້ມງວດຂອງເຮົາ.
            </p>
